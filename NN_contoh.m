...
save ('C:\ikhsan\UNAIR\SEMESTER 4\PEMBELAJARAN MESIN (PRAKTIKUM)\Tugas SVM dan NN\net_keluaran.mat')
...
load('C:\ikhsan\UNAIR\SEMESTER 4\PEMBELAJARAN MESIN (PRAKTIKUM)\Tugas SVM dan NN\net_keluaran.mat')

% Proses membaca data uji dari excel
filename = 'DataUji.xlsx';
sheet = 1;
xlRange = 'A2:C5';
Data = xlsread (filename, sheet, xlRange);
data_uji = Data(:,1:2)';
